  ...
  content.innerHTML = `
    <div class="text-center w-full max-w-lg mx-auto">
      ...
      <div class="upload-area mb-6" id="uploadArea">
        ...
        <p class="text-sm opacity-70 mb-2">Drag & drop your .txt file or click to browse</p>
        <p class="text-xs opacity-50">File must be exported from WhatsApp as .txt without media</p>
